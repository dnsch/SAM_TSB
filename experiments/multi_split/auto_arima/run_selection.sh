...
# Master script to run all AutoARIMA multi-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_arima.sh

BASE_DIR="experiments/multi_split/auto_arima"
...
echo "=============================================="
echo "Starting AutoARIMA multi-split experiments"
...
echo "=============================================="
echo "AutoARIMA multi-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
