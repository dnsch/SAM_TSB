...
# Master script to run all AutoMFLES multi-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_mfles.sh

BASE_DIR="experiments/multi_split/auto_mfles"
...
echo "=============================================="
echo "Starting AutoMFLES multi-split experiments"
...
echo "=============================================="
echo "AutoMFLES multi-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
