...
# Master script to run all HistoricAverage multi-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_historic_average.sh

BASE_DIR="experiments/multi_split/historic_average"
...
echo "=============================================="
echo "Starting HistoricAverage multi-split experiments"
...
echo "=============================================="
echo "HistoricAverage multi-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
