...
# Master script to run all Naive multi-split experiments (quiet mode with logging and timing)

# Usage: bash run_selection.sh

BASE_DIR="experiments/multi_split/naive"
...
echo "=============================================="
echo "Starting Naive multi-split experiments"
...
echo "=============================================="
echo "Naive multi-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
