...
# Master script to run selected PatchTST multi-split experiments (quiet mode with logging and timing)

# Usage: bash run_selection.sh

BASE_DIR="experiments/multi_split/patchtst"

# Methods/variants to run

METHODS=("base" "sam" "asam" "fsam" "gsam")

# Selected datasets to run
...
echo "=============================================="
echo "Starting selected PatchTST multi-split experiments"
...
echo "=============================================="
echo "Selected PatchTST multi-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
