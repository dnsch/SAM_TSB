...
# Master script to run SAMformer multi-split experiments (quiet mode with logging and timing)

# Automatically discovers which scripts exist in each method directory

# Usage: bash run_selection.sh

BASE_DIR="experiments/multi_split/samformer"
...
echo "=============================================="
echo "Starting SAMformer multi-split experiments"
...
echo "=============================================="
echo "SAMformer multi-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
