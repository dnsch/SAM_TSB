...
# Master script to run all SeasonalExponentialSmoothing multi-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_seasonal_exponential_smoothing.sh

BASE_DIR="experiments/multi_split/seasonal_exponential_smoothing"
...
echo "=============================================="
echo "Starting SeasonalExponentialSmoothing multi-split experiments"
...
echo "=============================================="
echo "SeasonalExponentialSmoothing multi-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
