...
# Master script to run all SeasonalNaive multi-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_seasonal_naive.sh

BASE_DIR="experiments/multi_split/seasonal_naive"
...
echo "=============================================="
echo "Starting SeasonalNaive multi-split experiments"
...
echo "=============================================="
echo "SeasonalNaive multi-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
