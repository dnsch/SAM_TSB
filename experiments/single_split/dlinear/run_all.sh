...
# Master script to run all DLinear experiments (quiet mode with logging and timing)

# Usage: bash run_all_dlinear.sh

BASE_DIR="experiments/single_split/dlinear"

# Methods/variants to run

METHODS=("base" "sam" "asam" "fsam" "gsam")

# Datasets to run

DATASETS=("etth1" "etth2" "ettm1" "ettm2" "exchange_rate" "national_illness" "weather")
...
echo "=============================================="
echo "Starting all DLinear experiments"
...
for method in "${METHODS[@]}"; do
    for dataset in "${DATASETS[@]}"; do
        CURRENT=$((CURRENT + 1))
        SCRIPT_PATH="${BASE_DIR}/${method}/${dataset}.sh"
...
echo "=============================================="
echo "All DLinear experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
