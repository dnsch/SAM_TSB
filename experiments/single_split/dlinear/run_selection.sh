...
# Master script to run selected DLinear experiments (quiet mode with logging and timing)
...
echo "=============================================="
echo "Starting selected DLinear experiments"
...
echo "=============================================="
echo "Selected DLinear experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
