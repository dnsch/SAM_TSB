...
# Master script to run all HistoricAverage single-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_historic_average.sh

BASE_DIR="experiments/single_split/historic_average"
...
echo "=============================================="
echo "Starting HistoricAverage single-split experiments"
...
echo "=============================================="
echo "HistoricAverage single-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
