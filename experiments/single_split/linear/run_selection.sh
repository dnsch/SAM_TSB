...
# Master script to run selected Linear experiments (quiet mode with logging and timing)

# Usage: bash run_selection.sh

BASE_DIR="experiments/single_split/linear"
...
echo "=============================================="
echo "Starting selected Linear experiments"
...
echo "=============================================="
echo "Selected Linear experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
