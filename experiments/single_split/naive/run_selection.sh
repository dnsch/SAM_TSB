...
# Master script to run all Naive single-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_naive.sh

BASE_DIR="experiments/single_split/naive"
...
echo "=============================================="
echo "Starting Naive single-split experiments"
...
echo "=============================================="
echo "Naive single-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
