...
# Master script to run selected NLinear experiments (quiet mode with logging and timing)

# Usage: bash run_selection.sh

BASE_DIR="experiments/single_split/nlinear"
...
echo "=============================================="
echo "Starting selected NLinear experiments"
...
echo "=============================================="
echo "Selected NLinear experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
