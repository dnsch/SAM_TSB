...
# Master script to run selected PatchTST experiments (quiet mode with logging and timing)

# Usage: bash run_selection.sh

BASE_DIR="experiments/single_split/patchtst"
...
echo "=============================================="
echo "Starting selected PatchTST experiments"
...
echo "=============================================="
echo "Selected PatchTST experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
