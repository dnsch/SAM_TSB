...
# Master script to run selected SAMformer experiments (quiet mode with logging and timing)

# Usage: bash run_selection.sh

BASE_DIR="experiments/single_split/samformer"
...
echo "=============================================="
echo "Starting selected SAMformer experiments"
...
echo "=============================================="
echo "Selected SAMformer experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
