...
# Master script to run all SeasonalExponentialSmoothing single-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_seasonal_exponential_smoothing.sh

BASE_DIR="experiments/single_split/seasonal_exponential_smoothing"
...
echo "=============================================="
echo "Starting SeasonalExponentialSmoothing single-split experiments"
...
echo "=============================================="
echo "SeasonalExponentialSmoothing single-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
