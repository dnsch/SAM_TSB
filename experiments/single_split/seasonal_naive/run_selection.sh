...
# Master script to run all SeasonalNaive single-split experiments (quiet mode with logging and timing)

# Usage: bash run_all_seasonal_naive.sh

BASE_DIR="experiments/single_split/seasonal_naive"
...
echo "=============================================="
echo "Starting SeasonalNaive single-split experiments"
...
echo "=============================================="
echo "SeasonalNaive single-split experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
