...
# Master script to run selected TimeKAN experiments (quiet mode with logging and timing)

# Usage: bash run_selection.sh

BASE_DIR="experiments/single_split/timekan"
...
echo "=============================================="
echo "Starting selected TimeKAN experiments"
...
echo "=============================================="
echo "Selected TimeKAN experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
