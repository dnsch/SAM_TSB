...
# Master script to run selected TSMixer experiments (quiet mode with logging and timing)

# Usage: bash run_selection.sh

BASE_DIR="experiments/single_split/tsmixer"
...
echo "=============================================="
echo "Starting selected TSMixer experiments"
...
echo "=============================================="
echo "Selected TSMixer experiments finished!"
echo "Started at:  ${OVERALL_START_FORMATTED}"
