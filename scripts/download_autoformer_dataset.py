...
# Script to download datasets used in autoformer (https://github.com/thuml/Autoformer).
# Not tested on MACOS
...
if __name__ == "__main__":
    ...
    # Check for DATA_DIR environment variable, otherwise use default relative path
    DATA_DIR = os.environ.get("DATA_DIR")
    if DATA_DIR:
        data_dir = os.path.join(DATA_DIR, "autoformer_datasets/")
    else:
        data_dir = os.path.join(SCRIPT_DIR, "../data/autoformer_datasets/")

    # Define temp directories (these can stay in SCRIPT_DIR)
    ...
    download_dataset("https://drive.google.com/uc?id=1alE33S1GmP5wACMXaLu50rDIoVzBM4ik", zip_file)
