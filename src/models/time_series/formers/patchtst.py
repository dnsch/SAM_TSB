...
class PatchTST(BaseModel):
    def __init__(
        ...
        max_seq_len = 1024,  # legacy, unused, but kept for compatibility
        d_k = None,
        d_v = None,
        norm = "BatchNorm",  # legacy, unused, but kept for compatibility, TODO: extend that param and allow for layer norm
        attn_dropout = 0.0,
        act = "gelu",
        key_padding_mask = "auto",  # legacy, unused, but kept for compatibility
        padding_var = None,  # legacy, unused, but kept for compatibility
        attn_mask = None,  # legacy, unused, but kept for compatibility
        res_attention = True,
        pre_norm = False,
        store_attn = False,
        pe = "zeros",
        ...
        pretrain_head = False,
        head_type = "flatten",
        verbose = False,  # legacy, unused, but kept for compatibility
        **kwargs,
    ):
