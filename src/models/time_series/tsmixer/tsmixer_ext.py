...
class TSMixerExt(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.fc_out = nn.Linear(hidden_channels, input_channels)
    ...
    def forward(
        ...
        Args:
            x_hist: Historical time series (batch_size, seq_len, input_channels).
        ...
        Returns:
            Output tensor (batch_size, pred_len, input_channels) or flattened.
        """
...
if __name__ == "__main__":
    ...
    x_hist = torch.randn(3, seq_len, input_channels)
